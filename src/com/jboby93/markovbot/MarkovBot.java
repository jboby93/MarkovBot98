...
public class MarkovBot {
	...
	public String generate() { return this.generate(-1, 100); }
	public String generate(int wordLimit) { return this.generate(-1, wordLimit); }
	...
	public void clearDatabase() { _db.clear(); } 
	public void loadDatabaseFrom(String file) { _db.load(file); }
	public void loadDatabase() { _db.load(); }
	public void saveDatabaseTo(String file) { _db.save(file); }
	public void saveDatabase() { _db.save(); }

	//used by event queue handler
	public void replaceDatabase(String file) { _db.load_replace(file); }
	public void importDatabase(String file) { _db.load_import(file); }
	...
	public int getDBSize() { return _db.getDBSize(); }
	public MarkovDB getDB() { return _db; }
